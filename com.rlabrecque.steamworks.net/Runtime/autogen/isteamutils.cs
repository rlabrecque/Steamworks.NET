...
namespace Steamworks {
	public static class SteamUtils {
		...
		public static ESteamHardwareType IsRunningOnSteamHardware() {
			InteropHelp.TestIfAvailableClient();
			return NativeMethods.ISteamUtils_IsRunningOnSteamHardware(CSteamAPIContext.GetSteamUtils());
		}
		...
		public static ESteamHardwareDefaultConfig GetSteamHardwareDefaultConfig() {
			InteropHelp.TestIfAvailableClient();
			return NativeMethods.ISteamUtils_GetSteamHardwareDefaultConfig(CSteamAPIContext.GetSteamUtils());
		}
		...
		public static bool IsRunningUnderProton() {
			InteropHelp.TestIfAvailableClient();
			return NativeMethods.ISteamUtils_IsRunningUnderProton(CSteamAPIContext.GetSteamUtils());
		}
	}
}
